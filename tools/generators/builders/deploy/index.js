...
var runBuilder = function (options, context) { return __awaiter(void 0, void 0, void 0, function () {
    var projectName, endpoint, registry, version, error, command;
    return __generator(this, function (_a) {
        projectName = context.target.project;
        if (!projectName) {
            return [2 /*return*/, new Promise(function (resolve) { return resolve({ success: false, error: 'Project name undefined' }); })];
        }
        ;
        endpoint = options.endpoint, registry = options.registry, version = options.version;
        try {
            command = "curl -d '{\"name\":\"" + registry + "/" + projectName + "\", \"tag\":\"" + (version || 'latest') + "\"}' -H \"Content-Type: application/json\" -X POST " + endpoint;
